      ...
      <div className="bg-white rounded-xl w-full max-w-md border border-gray-200 shadow-2xl overflow-hidden flex flex-col transition-all">
        ...
        <div className="p-5 space-y-3 bg-white">
          ...
          <p className="text-xs text-gray-600 leading-relaxed">
            This will open a terminal tab in Antigravity IDE (preferring <strong className="text-gray-800 font-mono">ProjectApp</strong>) and directly execute shell commands to remove and prune all worktrees existing in both repositories.
          </p>
